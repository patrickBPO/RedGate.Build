...
<#
        ...
        Copyright 2016, Red Gate Software Limited
		...
		.PARAMETER Encoding
		The optional encoding of the source file. If unspecified, defaults to 'UTF8'. Valid values include
		'Unicode', 'Byte', 'BigEndianUnicode', 'UTF8', 'UTF7', 'UTF32', 'Ascii', 'Default', 'Oem' and 'BigEndianUTF32'.
